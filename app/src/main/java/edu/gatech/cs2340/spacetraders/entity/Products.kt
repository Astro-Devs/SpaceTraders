...
enum class Products(val MTLP : TechLevels, val MTLU : TechLevels, val TTP: TechLevels,val BASEPRICE : Int,
    ...
    WATER(TechLevels.PREAGRICULTURE, TechLevels.PREAGRICULTURE, TechLevels.MEDIEVAL, 30,
        ...
        30, 50),
    FUR(TechLevels.PREAGRICULTURE, TechLevels.PREAGRICULTURE, TechLevels.PREAGRICULTURE, 250,
        10,10, RandomEvent.COLD, Resources.RICHFAUNA, Resources.LIFELESS,
        230, 280),
    FOOD(TechLevels.AGRICULTURE, TechLevels.PREAGRICULTURE, TechLevels.AGRICULTURE, 100,
        5, 5, RandomEvent.CROPFAIL, Resources.RICHSOIL, Resources.POORSOIL,
        90, 160),
    ORE(TechLevels.MEDIEVAL, TechLevels.MEDIEVAL, TechLevels.RENAISSANCE, 350, 20, 10,
        RandomEvent.WAR, Resources.MINERALRICH, Resources.MINERALPOOR, 350, 420),
    GAMES(TechLevels.RENAISSANCE, TechLevels.AGRICULTURE, TechLevels.POST_INDUSTRIAL, 250, -10, 5,
        RandomEvent.BOREDOM, Resources.ARTISTIC, Resources.NOSPECIALRESOURCES, 160, 270),
    FIREARMS(TechLevels.RENAISSANCE, TechLevels.AGRICULTURE, TechLevels.INDUSTRIAL, 1250, -75, 100,
        RandomEvent.WAR, Resources.WARLIKE, Resources.NOSPECIALRESOURCES, 600, 1100),
    MEDICINE(TechLevels.EARLYINDUSTRIAL, TechLevels.AGRICULTURE, TechLevels.POST_INDUSTRIAL, 650, -20,
        10, RandomEvent.PLAGUE, Resources.LOTSOFHERBS, Resources.NOSPECIALRESOURCES, 400, 700),
    MACHINES(TechLevels.EARLYINDUSTRIAL, TechLevels.RENAISSANCE, TechLevels.INDUSTRIAL, 900, -30, 5,
        RandomEvent.LACKOFWORKERS, Resources.NOSPECIALRESOURCES, Resources.NOSPECIALRESOURCES, 600, 800),
    NARCOTICS(TechLevels.INDUSTRIAL, TechLevels.PREAGRICULTURE, TechLevels.INDUSTRIAL, 3500, -125,
        150, RandomEvent.BOREDOM, Resources.WEIRDMUSHROOMS, Resources.NOSPECIALRESOURCES, 2000, 3000),
    ROBOTS(TechLevels.POST_INDUSTRIAL, TechLevels.EARLYINDUSTRIAL, TechLevels.HITECH, 5000, -150,
